 ...
 */
object ApiConfig {
    // 真机 USB 调试默认走 adb reverse，把手机的 127.0.0.1 转到电脑后端。
    // 模拟器改成 10.0.2.2；无线真机改成 start-platform.ps1 打印的电脑局域网 IP。
    private const val HOST = "127.0.0.1"

    /** 用户中心(MVP-0):登录/注册。真机 USB 调试用 adb reverse tcp:8080 tcp:80 转到 Nginx。 */
